...
# Look for "harteWired.claudelikebar" (Marketplace) or "harteWired.claudelike-bar" (Open VSX)
# — should say "activated" not "failed"
grep -EA2 'claudelike-?bar' ~/.vscode-server/data/logs/*/exthost*/remoteexthost.log
